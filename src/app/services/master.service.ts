...
export class MasterService {
    ...
    GetAllMenuApp(): Observable<MenuApp[] | string> {
        return this._httpClient.get<MenuApp[]>(`${this.baseAddress}api/Master/GetAllApps`).pipe(catchError(this.errorHandler));
    }
    ...
    CreateRole(role: RoleWithApp): Observable<any> {
        return this._httpClient.post<any>(`${this.baseAddress}api/Master/CreateRole`, role, {
            headers: new HttpHeaders({
                'Content-Type': 'application/json'
            })
        });
    ...
    GetAllRoles(): Observable<RoleWithApp[] | string> {
        return this._httpClient.get<RoleWithApp[]>(`${this.baseAddress}api/Master/GetAllRoles`).pipe(catchError(this.errorHandler));
    }
    GetRoleName(roleId: number): Observable<any> {
        return this._httpClient.get<any>(`${this.baseAddress}api/Master/GetRoleName>roleId=${roleId}`).pipe(catchError(this.errorHandler));
    }
    ...
    GetAllNormalUsers(): Observable<string[] | string> {
        return this._httpClient.get<string[]>(`${this.baseAddress}api/Master/GetAllNormalUsers`).pipe(catchError(this.errorHandler));
    }

    GetAllNormalUsersByUser(UserName: string): Observable<string[] | string> {
        return this._httpClient
            .get<string[]>(`${this.baseAddress}api/Master/GetAllNormalUsersByUser?UserName=${UserName}`)
            .pipe(catchError(this.errorHandler));
    }

    GetAllUserPlantMapViews(): Observable<UserPlantMapView[] | string> {
        return this._httpClient.get<UserPlantMapView[]>(`${this.baseAddress}api/Master/GetAllUserPlantMapViews`).pipe(catchError(this.errorHandler));
    }

    GetAllUserPlantMapViewsByUser(UserName: string): Observable<UserPlantMapView[] | string> {
        return this._httpClient
            .get<UserPlantMapView[]>(`${this.baseAddress}api/Master/GetAllUserPlantMapViewsByUser?UserName=${UserName}`)
            .pipe(catchError(this.errorHandler));
    }
    ...
    CreateUserPlantDocumentType(userPlantDocumentType: UserPlantDocumentType): Observable<any> {
        return this._httpClient
            .post<any>(
                `${this.baseAddress}api/Master/CreateUserPlantDocumentType`,
                userPlantDocumentType
                // {
                //   headers: new HttpHeaders({
                //     'Content-Type': 'application/json'
    ...
    GetAllUserPlantDocumentTypes(): Observable<UserPlantDocumentType[] | string> {
        return this._httpClient
            .get<UserPlantDocumentType[]>(`${this.baseAddress}api/Master/GetAllUserPlantDocumentTypes`)
            .pipe(catchError(this.errorHandler));
    }
    ...
    UpdateUserPlantDocumentType(userPlantDocumentType: UserPlantDocumentType): Observable<any> {
        return this._httpClient
            .post<any>(
                `${this.baseAddress}api/Master/UpdateUserPlantDocumentType`,
                userPlantDocumentType
                // {
                //   headers: new HttpHeaders({
                //     'Content-Type': 'application/json'
    ...
    DeleteUserPlantDocumentType(userPlantDocumentType: UserPlantDocumentType): Observable<any> {
        return this._httpClient
            .post<any>(`${this.baseAddress}api/Master/DeleteUserPlantDocumentType`, userPlantDocumentType, {
                headers: new HttpHeaders({
                    'Content-Type': 'application/json'
                })
            })
    ...
    CreatePriority(priority: Priority): Observable<any> {
        return this._httpClient
            .post<any>(`${this.baseAddress}api/Master/CreatePriority`, priority, {
                headers: new HttpHeaders({
                    'Content-Type': 'application/json'
                })
            })
    ...
    GetAllPriorities(): Observable<Priority[] | string> {
        return this._httpClient.get<Priority[]>(`${this.baseAddress}api/Master/GetAllPriorities`).pipe(catchError(this.errorHandler));
    }
    GetAllPriorityViews(): Observable<PriorityView[] | string> {
        return this._httpClient.get<PriorityView[]>(`${this.baseAddress}api/Master/GetAllPriorityViews`).pipe(catchError(this.errorHandler));
    }

    GetAllPriorityNames(): Observable<string[] | string> {
        return this._httpClient.get<string[]>(`${this.baseAddress}api/Master/GetAllPriorityNames`).pipe(catchError(this.errorHandler));
    }

    UpdatePriority(priority: Priority): Observable<any> {
        return this._httpClient
            .post<any>(`${this.baseAddress}api/Master/UpdatePriority`, priority, {
                headers: new HttpHeaders({
                    'Content-Type': 'application/json'
                })
            })
    ...
    DeletePriority(priority: Priority): Observable<any> {
        return this._httpClient
            .post<any>(`${this.baseAddress}api/Master/DeletePriority`, priority, {
                headers: new HttpHeaders({
                    'Content-Type': 'application/json'
                })
            })
    ...
    GetAllPlants(): Observable<Plant[] | string> {
        return this._httpClient.get<Plant[]>(`${this.baseAddress}api/Master/GetAllPlants`).pipe(catchError(this.errorHandler));
    }

    GetAllPlantViews(): Observable<PlantView[] | string> {
        return this._httpClient.get<PlantView[]>(`${this.baseAddress}api/Master/GetAllPlantViews`).pipe(catchError(this.errorHandler));
    }

    GetAllPlantViewsByUser(UserName: string): Observable<PlantView[] | string> {
        return this._httpClient
            .get<PlantView[]>(`${this.baseAddress}api/Master/GetAllPlantViewsByUser?UserName=${UserName}`)
            .pipe(catchError(this.errorHandler));
    }

    GetAllPlantNames(): Observable<string[] | string> {
        return this._httpClient.get<string[]>(`${this.baseAddress}api/Master/GetAllPlantNames`).pipe(catchError(this.errorHandler));
    }
    ...
    CreateDocumentType(documentType: DocumentOutputType): Observable<any> {
        return this._httpClient
            .post<any>(`${this.baseAddress}api/Master/CreateDocumentType`, documentType, {
                headers: new HttpHeaders({
                    'Content-Type': 'application/json'
                })
            })
    ...
    GetAllDocumentTypes(): Observable<DocumentOutputType[] | string> {
        return this._httpClient.get<DocumentOutputType[]>(`${this.baseAddress}api/Master/GetAllDocumentTypes`).pipe(catchError(this.errorHandler));
    }

    GetAllDocumentTypeViews(): Observable<DocumentTypeView[] | string> {
        return this._httpClient.get<DocumentTypeView[]>(`${this.baseAddress}api/ESigner/GetAllDocumentTypes`).pipe(catchError(this.errorHandler));
    }

    GetAllDocumentTypeViewsByUser(UserName: string): Observable<DocumentTypeView[] | string> {
        return this._httpClient
            .get<DocumentTypeView[]>(`${this.baseAddress}api/Master/GetAllDocumentTypeViewsByUser?UserName=${UserName}`)
            .pipe(catchError(this.errorHandler));
    }

    GetAllDocumentOutputTypeMapViews(): Observable<DocumentOutputTypeMapView[] | string> {
        return this._httpClient
            .get<DocumentOutputTypeMapView[]>(`${this.baseAddress}api/Master/GetAllDocumentOutputTypeMapViews`)
            .pipe(catchError(this.errorHandler));
    }

    GetAllDocumentOutputTypeMapViewsByUser(UserName: string): Observable<DocumentOutputTypeMapView[] | string> {
        return this._httpClient
            .get<DocumentOutputTypeMapView[]>(`${this.baseAddress}api/Master/GetAllDocumentOutputTypeMapViewsByUser?UserName=${UserName}`)
            .pipe(catchError(this.errorHandler));
    }

    GetAllDocumentTypeNames(): Observable<string[] | string> {
        return this._httpClient.get<string[]>(`${this.baseAddress}api/Master/GetAllDocumentTypeNames`).pipe(catchError(this.errorHandler));
    }

    UpdateDocumentType(documentType: DocumentOutputType): Observable<any> {
        return this._httpClient
            .post<any>(`${this.baseAddress}api/Master/UpdateDocumentType`, documentType, {
                headers: new HttpHeaders({
                    'Content-Type': 'application/json'
                })
            })
    ...
    DeleteDocumentType(documentType: DocumentTypes): Observable<any> {
        return this._httpClient
            .post<any>(`${this.baseAddress}api/Master/DeleteDocumentType`, documentType, {
                headers: new HttpHeaders({
                    'Content-Type': 'application/json'
                })
            })
    ...
    CreateOutputType(outputType: OutputType): Observable<any> {
        return this._httpClient
            .post<any>(`${this.baseAddress}api/Master/CreateOutputType`, outputType, {
                headers: new HttpHeaders({
                    'Content-Type': 'application/json'
                })
            })
    ...
    GetAllOutputTypes(): Observable<OutputType[] | string> {
        return this._httpClient.get<OutputType[]>(`${this.baseAddress}api/Master/GetAllOutputTypes`).pipe(catchError(this.errorHandler));
    }

    GetAllOutputTypeViews(): Observable<OutputTypeView[] | string> {
        return this._httpClient.get<OutputTypeView[]>(`${this.baseAddress}api/Master/GetAllOutputTypeViews`).pipe(catchError(this.errorHandler));
    }

    GetAllOutputTypeViewsByUser(UserName: string): Observable<OutputTypeView[] | string> {
        return this._httpClient
            .get<OutputTypeView[]>(`${this.baseAddress}api/Master/GetAllOutputTypeViewsByUser?UserName=${UserName}`)
            .pipe(catchError(this.errorHandler));
    }

    GetAllOutputTypeNames(): Observable<string[] | string> {
        return this._httpClient.get<string[]>(`${this.baseAddress}api/Master/GetAllOutputTypeNames`).pipe(catchError(this.errorHandler));
    }

    UpdateOutputType(outputType: OutputType): Observable<any> {
        return this._httpClient
            .post<any>(`${this.baseAddress}api/Master/UpdateOutputType`, outputType, {
                headers: new HttpHeaders({
                    'Content-Type': 'application/json'
                })
            })
    ...
    DeleteOutputType(outputType: OutputType): Observable<any> {
        return this._httpClient
            .post<any>(`${this.baseAddress}api/Master/DeleteOutputType`, outputType, {
                headers: new HttpHeaders({
                    'Content-Type': 'application/json'
                })
            })
    ...
    GetAllNotificationByUserID(UserID: string): Observable<UserNotification[] | string> {
        return this._httpClient
            .get<UserNotification[]>(`${this.baseAddress}api/Notification/GetAllNotificationByUserID?UserID=${UserID}`)
            .pipe(catchError(this.errorHandler));
    }

    UpdateNotification(SelectedNotification: UserNotification): Observable<any> {
        return this._httpClient
            .post<any>(`${this.baseAddress}api/Notification/UpdateNotification`, SelectedNotification, {
                headers: new HttpHeaders({
                    'Content-Type': 'application/json'
                })
            })
    ...
    GetAllAuthority(): Observable<AuthorityClass[] | string> {
        return this._httpClient.get<AuthorityClass[]>(`${this.baseAddress}api/ESigner/GetAllUserEmails`).pipe(catchError(this.errorHandler));
    }
}
